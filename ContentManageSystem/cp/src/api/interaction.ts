...
export const queryCommentsPage = async (params?: Record<string, any>): Promise<any> => (await axios.get('/backend/ext/comments', { params })).data;
export const queryComments = async (id: number): Promise<any> => (await axios.get(`/backend/ext/comments/${id}`)).data;
export const createComments = async (data: Record<string, any>): Promise<any> => (await axios.post('/backend/ext/comments', data)).data;
export const updateComments = async (data: Record<string, any>): Promise<any> => (await axios.post('/backend/ext/comments?_method=put', data)).data;
export const deleteComments = async (data: number[]): Promise<any> => (await axios.post('/backend/ext/comments?_method=delete', data)).data;
export const updateCommentsStatus = async (ids: number[], status: number): Promise<any> =>
    (await axios.post('/backend/ext/comments/status?_method=put', { ids, status })).data;
