    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          perms: ['articleReview:page', 'articleReview:list', 'articleReview:show', 'articleReview:create', 'articleReview:update', 'articleReview:updateStatus', 'articleReview:delete'],
          children: [
