...
public class ArticleExtBase implements Serializable {
    ...
    public void setTargetBlank(@Nullable Boolean targetBlank) {
    ...
    public void setAllowComment(@Nullable Boolean allowComment) {
    ...
    public void setBaiduPush(@Nullable Boolean baiduPush) {
